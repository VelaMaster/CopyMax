...
public class Clientes extends javax.swing.JPanel {
    ...
    private EntidadPersistente<Clientesclass> entidadPersistente;
    ...
    public Clientes() {
        ...
        modelo.addColumn("ID");            // Columna para el ID
        ...
        entidadPersistente = new ClienteAdapter(); // Usa el adaptador para Clientes
    ...
    private void BtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModificarActionPerformed
        ...
        if (selectedRow != -1) {  // Extrae los datos del cliente de la fila seleccionada
            ...
            String apellidos = (String) modelo.getValueAt(selectedRow, 2);
            String celular = (String) modelo.getValueAt(selectedRow, 3);
            String rfc = (String) modelo.getValueAt(selectedRow, 4);
            String correo = (String) modelo.getValueAt(selectedRow, 5);
            ...
            entidadPersistente.actualizar(cliente);
    ...
    private void actualizarTablabus() {
        ...
        if (textoBusqueda.equals("Numero a buscar")) {
            //Si el texto es igual al placeholder, mostrar todos los clientes
            actualizarTabla();
            return;
        }
        modelo.setRowCount(0); // Limpia la tabla

        List<Clientesclass> clientes = entidadPersistente.obtenerPorNumero(textoBusqueda); //Usa el Adapter
